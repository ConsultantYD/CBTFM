...
def render_figure(
    ...
    fig.update_yaxes(
        title_text="Flex<br>Contrib.<br>(kW)", range=[0, ymax], nticks=3, row=2, col=1
    )
    ...
    fig.update_yaxes(
        title_text="Storage<br>Avg<br>SoC<br>(%)",
        row=3,
        col=1,
    ...
    fig.update_yaxes(
        title_text="Building<br>Avg<br>Temp<br>(°C)",
        row=4,
        col=1,
    ...
    fig.update_yaxes(
        title_text="C&I<br>Total<br>Load<br>(kW)",
        row=5,
        col=1,
    ...
    fig.update_yaxes(title_text="Total System Load<br>(kW)", row=1, col=1)
    ...
    # Match top y-label font to others (smaller, not bold)
    fig.update_yaxes(row=1, col=1, title_font=small_title)
    # Make the last 3 subplot y-labels even more compact
    for r in (3, 4, 5):
        fig.update_yaxes(row=r, col=1, title_font=dict(size=9))
